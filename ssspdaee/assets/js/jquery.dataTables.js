...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		//var input = '<input type="search" class="'+classes.sFilterInput+' input-xlarge " placeholder="Pesquisar"/>';
                
                var input ='<div class="input-group" >\n\
                                <input type="search" class="form-control col-sm-12 '+classes.sFilterInput+' " autofocus placeholder="Pesquisar" sTyle="width:600px;"/>\n\
                                <div class="btn btn-primary" >Pesquisar</div> \n\
                            </div>';
